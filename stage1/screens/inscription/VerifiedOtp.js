      ...
      <ScrollView >
        <TouchableOpacity  onPress={()=>Navigation.goBack()} style={{flexDirection:'row',alignItems:'center',justifyContent:'flex-start',gap:7,marginBottom:18}}>
          ...
          <Text style={{color:'black',fontWeight:'bold',fontSize:26}}>Retour</Text>
            ...
            <Text style={{fontSize:35,color:'#2B4794',fontWeight:'bold',textAlign:'left'}}>Verification</Text>
        ...
        <View style={styles.container}>
          {otp.map((digit, index) => (
            ...
            />
                ...
                <TouchableOpacity onPress={handlerValide} style={{backgroundColor:'#2B4794',padding:15,borderRadius:15,width:300,justifyContent:'center',alignItems:'center',marginTop:40}}>
                ...
                <View style={{flexDirection:'row',marginTop:12,gap:5}}>
                  ...
                  <Text style={{color:'#2B4794',fontWeight:'bold', fontSize:18}}>renvoyer</Text>
                </View>
          </View>
      </ScrollView>
    </SafeAreaView>
