...
export default function SucceSign() {
  ...
  return (
    <SafeAreaView style={{flex:1, backgroundColor:'white',padding:20}}>
        <Text style={{fontSize:33,color:'#2B4794',fontWeight:'bold',textAlign:'left'}}>Compte créé avec succès!</Text>
        <Text style={{fontSize:19, color:'black',fontWeight:'bold',textAlign:'left'}}>Bienvenue sur BudgetManager</Text>
