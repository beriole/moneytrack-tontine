...
const styles = StyleSheet.create({
  ...
  infoCard: { backgroundColor: "#1E2A47", padding: 10, borderRadius: 12, alignItems: "center", elevation: 5 },
  ...
  modalContent: { width: "85%", backgroundColor: "#1E2A47", borderRadius: 12, padding: 20 },
  modalTitle: { color: "#fff", fontSize: 20, fontWeight: "bold", marginBottom: 15 },
  input: { backgroundColor: "#0D1B2A", color: "#fff", padding: 10, borderRadius: 8, marginBottom: 10 },
