...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: "#1E90FF", paddingVertical: 14, paddingHorizontal: 50, borderRadius: 12, marginTop: 20, marginBottom: 10, alignSelf: "center" },
  buttonText: { color: "#fff", fontSize: 16, fontWeight: "600" },
  secondaryButton: { borderColor: "#1E90FF", borderWidth: 2, paddingVertical: 12, paddingHorizontal: 40, borderRadius: 12, alignSelf: "center",marginBottom:23 },
  secondaryText: { color: "#1E90FF", fontSize: 15, fontWeight: "600" },
  ...
  modalButton: { backgroundColor:'#1E90FF', padding:12, borderRadius:10, width:'100%', marginBottom:10, alignItems:'center' },
  modalButtonText: { color:'#fff', fontWeight:'bold', fontSize:16 },
  modalCancel: { padding:10 },
  modalCancelText: { color:'#1E90FF', fontWeight:'bold', fontSize:16 },
});
