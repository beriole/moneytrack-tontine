    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 30 }}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            <View style={styles.rowLeft}>
              <AntDesign name="lock" size={22} color="#6366F1" />
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            <View style={styles.rowLeft}>
              <MaterialIcons name="notifications" size={22} color="#6366F1" />
          ...
          <View style={styles.row}>
            <View style={styles.rowLeft}>
              <MaterialIcons name="warning" size={22} color="#6366F1" />
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            <View style={styles.rowLeft}>
              <MaterialIcons name="dark-mode" size={22} color="#6366F1" />
          ...
          <View style={styles.row}>
            <View style={styles.rowLeft}>
              <Entypo name="globe" size={22} color="#6366F1" />
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            <View style={styles.rowLeft}>
              <AntDesign name="file-text" size={22} color="#6366F1" />
          ...
          <View style={styles.row}>
            <View style={styles.rowLeft}>
              <AntDesign name="exclamation-circle" size={22} color="#6366F1" />
