  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.addCatBtn} onPress={ajouterCategorie}>
        <AntDesign name="plus-circle" size={18} color="#fff" />
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#161427", padding: 20 },
  ...
  subtitle: { color: "#6366F1", fontSize: 16, fontWeight: "bold", marginVertical: 10 },
  dateBtn: {
