...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: "#211C3A", color: "#fff", padding: 12, borderRadius: 12 },
  pickerContainer: { backgroundColor: "#211C3A", borderRadius: 12, marginBottom: 10 },
  picker: { color: "#fff", height: 50 },
  button: { backgroundColor: "#6366F1", padding: 15, borderRadius: 12, alignItems: "center", marginTop: 25 },
