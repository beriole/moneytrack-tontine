        ...
        {projets.map(p => (
          <Swipeable key={p.id} renderRightActions={() => renderRightActionsProjet(p.id)}>
            ...
            >
              ...
              <View style={[styles.projectStatus, { backgroundColor: p.etat === "en cours" ? "#6366F1" : "#16A34A" }]}>
...
export default function BudgetProjetTabs() {
  return (
    <Tab.Navigator
      screenOptions={{
        tabBarStyle: { backgroundColor: "#161427" },
...
const styles = StyleSheet.create({
  ...
  budgetCard: { backgroundColor: "#211C3A", padding: 20, borderRadius: 16, marginBottom: 15 },
  budgetTitle: { color: "#fff", fontSize: 18, fontWeight: "bold", marginBottom: 8 },
  budgetAmount: { color: "#6366F1", fontSize: 16, fontWeight: "600", marginBottom: 6 },
  budgetPeriod: { color: "#9CA3AF", fontSize: 14 },

  projectCard: { backgroundColor: "#211C3A", padding: 20, borderRadius: 16, marginBottom: 15 },
  projectTitle: { color: "#fff", fontSize: 18, fontWeight: "bold", marginBottom: 8 },
  projectAmount: { color: "#6366F1", fontSize: 16, fontWeight: "600", marginBottom: 6 },
